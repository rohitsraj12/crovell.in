<?php
    $web_url = "http://localhost/project/CROVELL-WEBSITE/public/";
...
if(isset($_POST['submit'])){
    ...
    if(in_array($file_check,$file_ext_store)){
        ...
        // VALUES ('$product_name','$product_category', '$destination_file','$active')";
$query = "UPDATE products set product_name = '$product_name', 
product_category = '$product_category', 
product_image = '$destination_file', 
product_active = 'active' WHERE product_id=$product_id"; 

        $result = mysqli_query($conn, $query);

        
       header('location:'.$web_url.'dashboard/fetch_data.php');
    }
}
?>
